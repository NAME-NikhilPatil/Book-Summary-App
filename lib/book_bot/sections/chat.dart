import 'package:books_demo/book_bot/widgets/chat_input_box.dart';
...
class _SectionChatState extends State<SectionChat> {
      ...
      children: [
        Expanded(
            child: chats.isNotEmpty
                ...
                : const Center(child: Text('Ask me Anything about books!'))),
  ...
  Widget chatItem(BuildContext context, int index) {
    ...
    return Card(
      elevation: 0,
      color: content.role == 'model' ? primaryColor : Colors.transparent,
      child: Padding(
